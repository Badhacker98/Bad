...
def get_progress_bar2(percentage):
    umm = math.floor(percentage)
    if 0 < umm <= 10:
        return "𓆩🎵𓆪  ✦ 𝗦𝗣𝗢𝗧𝗜𝗙𝗬 𝗣𝗥𝗢𝗚𝗥𝗘𝗦𝗦 ✦ 𓆩🎶𓆪"
    elif 10 < umm <= 20:
        return "𓆩🎵𓆪  🎶 𝗧𝗛𝗜𝗦 𝗦𝗢𝗡𝗚 𝗜𝗦 𝗩𝗘𝗥𝗬 𝗕𝗘𝗔𝗨𝗧𝗜𝗙𝗨𝗟 🎶 𓆩🎶𓆪"
    elif 20 < umm <= 30:
        return "𓆩🎵𓆪  ♪ 𝗠𝗘𝗟𝗢𝗗𝗬 𝗙𝗟𝗢𝗪𝗦 𝗧𝗛𝗥𝗢𝗨𝗚𝗛 🎙️ 𓆩🎶𓆪"
    elif 30 < umm <= 40:
        return "𓆩🎵𓆪  🎧 𝗣𝗟𝗔𝗬𝗜𝗡𝗚 𝗬𝗢𝗨𝗥 𝗙𝗔𝗩𝗢𝗥𝗜𝗧𝗘 🎥 𓆩🎶𓆪"
    elif 40 < umm <= 50:
        return "𓆩🎵𓆪  ✨ 𝗧𝗛𝗘 𝗩𝗜𝗕𝗘𝗦 𝗔𝗥𝗘 𝗥𝗘𝗔𝗟 ✨ 𓆩🎶𓆪"
    elif 50 < umm <= 60:
        return "𓆩🎵𓆪  ⚕️ 𝗘𝗡𝗝𝗢𝗬 𝗧𝗛𝗘 𝗦𝗢𝗨𝗡𝗗𝗦 ⚕️ 𓆩🎶𓆪"
    elif 60 < umm <= 70:
        return "𓆩🎵𓆪  ✩ 𝗬𝗢𝗨𝗥 𝗠𝗨𝗦𝗜𝗖 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 ✩ 𓆩🎶𓆪"
    elif 70 < umm <= 80:
        return "𓆩🎵𓆪  ❤️ 𝗙𝗘𝗘𝗟𝗜𝗡𝗚 𝗧𝗛𝗘 𝗕𝗘𝗔𝗧𝗦 ❤️ 𓆩🎶𓆪"
    elif 80 < umm <= 90:
        return "𓆩🎵𓆪  🎧 𝗧𝗛𝗔𝗡𝗞𝗦 𝗙𝗢𝗥 𝗨𝗦𝗜𝗡𝗚 𝗦𝗣𝗢𝗧𝗜𝗙𝗬 𝗠𝗨𝗦𝗜𝗖 🎧 𓆩🎶𓆪"
    elif 90 < umm <= 100:
        return "𓆩🎵𓆪  ✩ 𝗔𝗟𝗠𝗢𝗦𝗧 𝗗𝗢𝗡𝗘 𝗣𝗟𝗔𝗬𝗜𝗡𝗚 ✩ 𓆩🎶𓆪"
    else:
