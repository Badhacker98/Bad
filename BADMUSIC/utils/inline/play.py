...
def get_progress_bar2(percentage):
    ...
    if 0 < umm <= 10:
        ...
        return "🎧 ︎၊lıılııllııılı||၊।||||| 🎥"
    elif 40 < umm <= 50:
        return "✨ •lıılıılıılı|||||lı|||| 🎤"
    elif 50 < umm <= 60:
        return "⚕️ılıılıııılıılıı|||lı||| 🎼"
    elif 60 < umm <= 70:
        return "✩ ︎၊lıılıılıılı၊|၊ılı|।||||| ♬"
    elif 70 < umm <= 80:
        return "❤️ |||||ılıılıılı|||||| 🎧"
    elif 80 < umm <= 90:
        return "✩ ︎၊lıılıııılıı|ııı၊||lıı 💕"
    elif 90 < umm <= 100:
        return "👑︎ lıılıılııılıılıılıııı🎷"
    else:
